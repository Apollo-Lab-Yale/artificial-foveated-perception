# ------------------------------------------------------------------------
# Text conditioning modules for AFP.
# ------------------------------------------------------------------------
...
class FrozenCLIPTextEncoder(object):
    """
    Frozen CLIP text encoder with a tiny CPU-side LRU cache.
    Designed to work with the OpenAI CLIP package on older PyTorch versions.
    """
